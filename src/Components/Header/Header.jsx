  ...
  return (
    ...
    <div className='flex items-center justify-center'>
        <div className='text-description  w-[50%]'>
            <h3 className='capitalize large-text'>
                select your new perfect style
            </h3>
            <p className='header-paragraph'>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Ad, sapiente. Aut vero aperiam voluptatibus culpa laudantium assumenda dolor!</p>
