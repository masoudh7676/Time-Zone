  ...
  return (
    <>
      ...
      <div className='mx-auto text-center'>
        <h3 className="capitalize text-2xl relative before:content-[''] before:absolute before:ml-20 before:w-[5%]  before:rounded-2xl before:bg-[#eb566c] before:h-1 before:top-3">our mission</h3>
      </div>
      <div>
