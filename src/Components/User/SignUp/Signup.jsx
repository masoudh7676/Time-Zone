        ...
        <h2 className='text-center text-2xl mb-12'>Sign Up</h2>
          <form className="flex-col space-y-4">
            <div className="flex flex-col space-y-2">
              <label className="block font-medium text-gray-700">E-Mail Adress</label><input type="email" className="shadow-sm block w-full py-2  rounded-md text-gray-800 disabled:bg-gray-200 sm:text-sm border-gray-300 focus:ring-primary-500 focus:border-primary-500 placeholder-gray-400 focus:outline-none  " name="email" required="" placeholder="E-Mail Adress" />
            </div>
            <div className="flex flex-col space-y-2">
              <label className="block font-medium text-gray-700">Password <span className="text-gray-500 font-base text-sm"></span></label><input type="password" className="shadow-sm block w-full py-2  rounded-md text-gray-800 disabled:bg-gray-200 sm:text-sm border-gray-300 focus:ring-primary-500 focus:border-primary-500 placeholder-gray-400 focus:outline-none" name="password" minLength = "6" placeholder="Password" required="" />
            </div>
            <div className="flex flex-col space-y-2">
              <label className="block font-medium text-gray-700">First and Last Name</label><input type="text" className="shadow-sm block w-full py-2 rounded-md text-gray-800 disabled:bg-gray-200 sm:text-sm border-gray-300 focus:ring-primary-500 focus:border-primary-500 placeholder-gray-400 focus:outline-none  " name="displayName" required="" placeholder="First and Last Name" />
            </div>
            <div className="flex flex-col space-y-2">
